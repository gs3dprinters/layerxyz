...
const BASE_PRODUCTS: Product[] = [
  {
    ...
    madeToOrder: true,
    details: {
      description: 'An authentic bespoke artisan statue commissioned and crafted in our Tiruppur studio, capturing authentic portrait expressions, clothing details, and sculptural contours from your photos.',
      ...
      specifications: 'Source: Customer Photos · Detail: High-definition studio finish · Finishing: Multi-stage surface conditioning',
    },
  ...
  },
  {
    ...
    madeToOrder: true,
    details: {
      description: 'An authentic bespoke artisan statue commissioned and crafted in our Tiruppur studio, capturing authentic portrait expressions, clothing details, and posture from your photos.',
