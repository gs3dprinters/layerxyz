...
const BASE_PRODUCTS: Product[] = [
  {
    ...
    isCustomizable: true,
    images: [
      '/images/products/custom-portrait-sculpture/primary.webp',
      '/images/products/custom-portrait-sculpture/gallery-01.webp',
      '/images/products/custom-portrait-sculpture/gallery-02.webp',
      '/images/products/custom-portrait-sculpture/gallery-03.webp',
    ],
  ...
  },
  {
    ...
    images: [
      '/images/products/heritage-nandi-sculpture/primary.webp',
      '/images/products/heritage-nandi-sculpture/gallery-01.webp',
      '/images/products/heritage-nandi-sculpture/gallery-02.webp',
      '/images/products/heritage-nandi-sculpture/gallery-03.webp',
      '/images/products/heritage-nandi-sculpture/gallery-04.webp',
      '/images/products/heritage-nandi-sculpture/gallery-05.webp',
      '/images/products/heritage-nandi-sculpture/gallery-06.webp',
    ],
  ...
  },
  {
    ...
    isCustomizable: true,
    images: [
      '/images/products/kala-portrait-statue/primary.webp',
      '/images/products/kala-portrait-statue/gallery-01.webp',
      '/images/products/kala-statue-optimized.jpg',
    ],
    model: '/models/kala-final-print.glb',
    sizes: [
